...
import { ITransactionsResponse, SearchValues } from '../types/transactions.types';
...
export const useTransactions = () => {
  ...
  const { data, refetch, isLoading, isError, isFetching } = useQuery<ITransactionsResponse | undefined>(QUERY_KEYS.getTransactions, fetchTransactions);
