...
export const Transaction = ({ data, currentBlock }: IProps) => {
  return (<ul className={`${styles.transaction} ${globalStyles.list}`}>
    <li>{data.blockNumber}</li>
    <li><a href={`https://etherscan.io/tx/${data.transactionId}`} target="_blank">{shortenStringTo12(data.transactionId)}</a></li>
