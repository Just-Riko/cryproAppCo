...
export const convertToGwei = (value: string) => parseInt(value, 16) * gweiValueToEth;
export const convertToEth = (value: string) => parseInt(value, 16) * gweiValueToEth * gweiValueToEth;
...
export const formatTransaction = <T extends ITransactionResponse>(data: T, gasUsed: string, timestamp: number): ITransaction => {
